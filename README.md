...
## Aurora v7.0 (arquitectura modular en Rust)
Se añadió un módulo de referencia en `aurora_v7/` que implementa:
- `AgentAndModelManager`
- `IntelligentTaskRouter`
- agentes especializados (`SecurityAgent`, `MediaAgent`, `AutomationAgent`)
- `MultimodalMemorySystem`
- interfaces (`Agent`, `ModelProvider`, `MemoryStore`)
